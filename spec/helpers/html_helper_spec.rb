...
describe HtmlHelper do
  ...
  let(:model){UserDecorator.new(stub_model(User, :name => 'steve', :phone => '0987654321'))}
  
  it 'should return an instance of LoveFormHelper' do
    form_for(model, url: '/hey') do |f|
  ...
  it 'should return an input type text htmlcontrol group "user_name"' do
    form_for(model, url: '/hey') do |f|
      lfh = helper.love_form_helper(f)
  ...
  it 'should return an input type text htmlcontrol with the supplied value"' do
    form_for(model, url: '/hey') do |f|
      lfh = helper.love_form_helper(f)
      lfh.control_group(:phone, :input => {value: 'hrabal'}).html.should == CG_VALUE.html
    end
  end
  ...
  it 'should return a password htmlcontrol group "user_name"' do
    form_for(model, url: '/hey') do |f|
      lfh = helper.love_form_helper(f)
...
<div class="control-group ">
         ...
         <div class="controls">
             <input class="input-xlarge" id="user_name" name="user[name]" size="30" type="text" value="steve" />
         </div>
       </div>
CG_NAME
...
<div class="control-group ">
         ...
         <div class="controls">
             <input class="input-xlarge" id="user_phone" name="user[phone]" size="30" type="text" value="hrabal" />
         </div>
       </div>
CG_VALUE
...
<div class="control-group ">
         <label class="control-label" for="user_name">Name</label>
         <div class="controls">
             <input data-stuff="abc123" class="input-xlarge" id="user_name" name="user[name]" size="30" type="text" value="steve" />
         </div>
       </div>
CG_INPUT_DATA_STUFF
...
<div class="control-group ">
         <label class="control-label" for="user_name">Name</label>
         <div class="controls">
             <input class="input-xlarge" id="user_name" name="user[name]" size="30" type="password" />
         </div>
       </div>
CG_PASSWORD
...
<div class="control-group ">
         <label class="control-label" for="user_name">Name</label>
         <div class="controls">
             <input class="input-xlarge" id="user_name" name="user[name]" size="30" type="text" value="steve" /><span class="add-on">.some add on </span>
         </div>
       </div>
CG_ADD_ON
...
CG_LABEL = <<CG_LABEL
<div class="control-group ">
         <label class="control-label" for="user_name">some other label</label>
         <div class="controls">
             <input class="input-xlarge" id="user_name" name="user[name]" size="30" type="text" value="steve" />
         </div>
       </div>
